const cardData = [
  {
    ...
    heading: '<h2>Holistic <span class="yellow-text">Development</span></h2>',
  ...
  },
  {
    ...
    heading:
      '<h2><span class="yellow-text">Proven</span> and <span class="yellow-text">Tested</span> Centralized Curriculum</h2>',
    subHeading:
  ...
  },
  {
    ...
    heading:
      '<h2><span class="yellow-text">Innovative</span> and <span class="yellow-text">Challenging</span> learning Methodologies</h2>',
    subHeading:
  ...
  },
  {
    ...
    heading:
      '<h2><span class="yellow-text">Faculty</span> Enrichment Program</h2>',
